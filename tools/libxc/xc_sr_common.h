...
static inline int xc_sr_test_and_clear(unsigned long bit, struct xc_sr_bitmap *bm)
{
    return test_and_clear_bit(bit, bm->p);
}

static inline int xc_sr_test_and_set(unsigned long bit, struct xc_sr_bitmap *bm)
{
